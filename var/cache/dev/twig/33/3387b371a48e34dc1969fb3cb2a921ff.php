...
/* home/api.html.twig */
class __TwigTemplate_406dfc6109db1b1f285f77707df34ce2 extends Template
{
    private $source;
    private $macros = [];
...
<a href=\"";
        // line 14
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("book_by_isbn", ["isbn" => 1234567]);
...
<a href=\"{{ path('book_by_isbn', {'isbn': 1234567}) }}\"><strong>api/library/book/{isbn}:</strong></a><p>Find a book by its Isbn.</p>
