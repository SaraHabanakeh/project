...
/* base.html.twig */
class __TwigTemplate_ffe21519c3947a6f9f7a747f1e0b5229 extends Template
{
    private $source;
    private $macros = [];
    ...
    <body>
        <nav>
            <ul>
                ...
                <li class='item-2'><a href=\"{{ path('about') }}\">About</a></li>
                <li class='item-3'><a href=\"{{ path('report') }}\">Report</a></li>
                <li class='item-4'><a href=\"{{ path('lucky') }}\">Lucky</a></li>
                <li class='item-1'><a href=\"{{ path('card_start') }}\">Card</a></li>
                <li class='item-2'><a href=\"{{ path('game-page') }}\">Game</a></li>
                <li class='item-3'><a href=\"{{ path('app_book') }}\">Library</a></li>
                <li class='item-4'><a href=\"{{ path('code_metrics') }}\">Metrics Analys</a></li>
                 <li class='item-1'><a href=\"{{ path('api') }}\">API</a></li>
            </ul>
        </nav>
    </body>
     <main class=\"home\">
...
", "base.html.twig", "/Users/sarahabanakeh/dbwebb-kurser/mvc/me/report/templates/base.html.twig");
    }
}
